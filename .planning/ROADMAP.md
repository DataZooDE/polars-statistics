...
- [x] 03-02-PLAN.md — energy_distance_nd expression + Python builder (STAT-04)
...
- [x] 04-01-PLAN.md — GammaRegressor tracer: `Gamma` PyModel wired end-to-end (3-file registration + smoke test) (REGR-03)
...
- [x] 04-03-PLAN.md — 5 GLM diagnostic expressions + HC extension on Ridge/WLS + expression registration (REGR-04/05)

**Wave 4** *(blocked on 04-03 — shares registration files)*

- [x] 04-04-PLAN.md — `TheilSen`, `RANSAC`, `BayesianRidge`, `ARD` PyModels + registration + smoke tests (REGR-06)

**Wave 5** *(blocked on 04-04 — shares registration files)*

- [x] 04-05-PLAN.md — `LARS`, `PassiveAggressive`, `MomentAccumulator` PyModels + OLS/Ridge `fit_from_accumulator` + registration (REGR-06)
...
- [x] 05-03-PLAN.md — DOCS-02: add mkdocs reference sections + nav for all remaining new API; clean mkdocs build
- [x] 05-04-PLAN.md — DOCS-04: complete the CHANGELOG 0.6.0 section (new API, crate bumps, column-pivot fix, known limitations)
