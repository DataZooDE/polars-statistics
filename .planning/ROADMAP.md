...
- [ ] 03-01-PLAN.md — ANOVA family tracer: one/two-way + RM-ANOVA expressions, output schemas, Python builders, ANOVA smoke tests (STAT-01/02/03)
...
| 3. Statistics API Parity | 0/4 | Planned | - |
